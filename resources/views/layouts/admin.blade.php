...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/libs/blog-post.css') }}">
    ...
    <link rel="stylesheet" href="css/libs/metisMenu.css">
    <link rel="stylesheet" href="css/libs/sb-admin-2.css"> -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    @else
                    {{Auth::user()->name}}
                     @endguest<i class="fa fa-caret-down">
...
<script src="{{ URL::asset('js/libs/metisMenu.js') }}"></script>
<script src="{{ URL::asset('js/libs/scripts.js') }}"></script>
